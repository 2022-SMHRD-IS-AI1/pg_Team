...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navigation-nav">
					<ul class="nav navbar-nav navbar-right">
						<li class="active"><a class="section-scroll" href="login.jsp">로그인</a></li>
  ...
  ================================================== -->
		<!--  --><section>
			<div id="hero-section" class="landing-hero"
					...
					<div class="container">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
									...
									<div class="herolider">
										<ul class="caption-slides">
											...
											<li class="caption">
												...
												<p class="hero">살뺄 수 있다!! &amp; 어디한번 빼보자구!!</p>
											</li>

											<li class="caption">
												<h1>야 너도 할 수 있어</h1>
												<div class="div-line"></div>
												<p class="hero">운동 &amp; 식습관</p>
											</li>
								...
								<div class="hero-btn">
									<a href="#creative-section-1" class="btn btn-clean">Read More</a>
								</div>
								<!-- end hero-btn -->
		...
		<!-- <section>
			<div id="landing-offer" class="pad-sec">
				<div class="container">
					...
					<div class="title-section big-title-sec animated out"
						data-animation="fadeInUp" data-delay="0">
						<div class="row">
							<div class="col-sm-8 col-sm-offset-2">
								<h2 class="big-title">Physical gallery</h2>
								<h1 class="big-subtitle">당신의 비만도를 체크할 수 있습니다!</h1>
								<hr>
					...
					<!--<div class="offer-boxes">
						...
						<div class="row">
							<div class="col-sm-4">
								<div class="offer-post text-center animated out"
									data-animation="fadeInLeft" data-delay="0">
									<div class="offer-icon">
										<img id="calcul" alt="" src="assets/icon/calcul.png">
									</div>
									<h4>비만도 계산하기</h4>
									<p class="ob_info">
										BMI 이외의 7가지 검사를 통해<br> 비만도를 분석하세요!
									</p>
								</div>
								<!-- End offer-post -->
							<!--</div>
							...
							<!--<div class="col-sm-4">
								<div class="offer-post text-center animated out"
									data-animation="fadeInUp" data-delay="0">
									<div class="offer-icon">
										<img id="calcul" alt="" src="assets/icon/chart.png">
									</div>
									<h4>내 기록 관리하기</h4>
									<p class="ob_info">
										꾸준한 운동을 통해<br> 변해가는 내 모습을 확인하세요!
									</p>
								</div>
								<!-- End offer-post -->
							<!--</div>
							...
							<!--<div class="col-sm-4">
								<div class="offer-post text-center animated out"
									...
									<div class="offer-icon">
										<img id="calcul" alt="" src="assets/icon/health.png">
									</div>
									<h4>질병 예방하기</h4>
									<p class="ob_info">
										비만으로 인해 발생할 수 있는<br> 성인병 정보를 기억하세요!
									</p>
								</div>
								<!-- End offer-post -->
							<!--</div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-7 img-creative-left text-center animated out" data-animation="fadeInLeft" data-delay="0">
              <figure>
                <iframe id="line_chart" src="chart_ex/line_chart.html" frameborder="0" style="width: 700px; height: 500px"></iframe>
              </figure>
            </div> <!-- End col-sm-8 -->
				...
				<div class="container">
					<div class="row">
						...
						<div
							...
							data-animation="fadeInRight" data-delay="0">
							<figure>
								<iframe src="chart_ex/pie_chart.html" frameborder="0" style="width: 650px; height: 600px"></iframe>
							</figure>
						</div>
						<!-- End col-sm-8 -->
    ...
    ================================================== -->
        ...
        <div id="screenshots-section" class="pad-sec">
          <div class="container">
		<iframe src="chart_ex/bar_chart.html" frameborder="0" style="width: 1000px; height: 600px"></iframe>
           <div class="title-section text-center animated out" data-animation="fadeInUp" data-delay="0">
              <div class="row">
                <div class="col-sm-8 col-sm-offset-2">
