...
CREATE TABLE MEMBER_BODY_INFO (
    ...
    MASS NUMBER(3,1) NOT NULL,
    WAIST NUMBER(3,1) NOT NULL,
    HIP NUMBER(3,1) NOT NULL,
...
CREATE SEQUENCE  CGI_4_1220_4.MEMBER_BOARD_SEQ  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE ;
